...
class SevenScenes(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        objs = {}
        objs['color'] = '/mnt/share/sda1/dataset/ghbdata/' + self.scene + '/' + seq_id + '/' + frame_id + '.color.png'
        objs['pose'] = '/mnt/share/sda1/dataset/ghbdata/' + self.scene + '/' + seq_id + '/' + frame_id + '.pose.txt'  # Twc
        objs['depth'] = '/mnt/share/sda1/dataset/ghbdata/' + self.scene + '/' + seq_id + '/' + frame_id + '.depth.png'
